      ...
      <div class="container background-image" data-aos="fade-up">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-5 d-flex flex-column justify-content-center">
            ...
            <p>Palazzo General Contracting Company, established in 2018 in the United Arab Emirates headquarters in Abu-Dhabi, with the aim of contributing development and construction work to the state's projects and in line with its regulations. Provides construction services superior in its field with speed, quality of work and good handling of all work parties.
            </p>
          </div>

          <div class="col-lg-6 img-bg" style="background-image: url(assets/img/about.jpg);" data-aos="zoom-in" data-aos-delay="120"></div>
        </div>
    ...
    <section id="stats-counter" class="stats-counter section-bg">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item d-flex align-items-center w-100 h-100">
              <i class="bi bi-hourglass color-green flex-shrink-0"></i>
              <div>
    ...
    <section id="alt-services" class="alt-services">
      <div class="container background-image" data-aos="fade-up">
        ...
        <div class="row justify-content">
          ...
          <div class="col-lg-5 d-flex flex-column justify-content-center">
            <h3>Our Vision</h3>
            <p>Our vision is to be recognized as the premier choice for general contracting services, setting the benchmark for excellence in the industry. We envision a future where our company continues to grow and expand, forging strong partnerships with clients, suppliers and subcontractors. We aspire to be at the forefront of technological advancements, embracing innovation to improve efficiency and enhance project outcomes.</p>
    ...
    <section id="alt-services-2" class="alt-services section-bg">
      <div class="container background-image" data-aos="fade-up">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-5 d-flex flex-column justify-content-center">
            <h3>Our Mission</h3>
            <p>Our mission is to be a leading general contracting company that consistently delivers high-quality construction services, exceeding the expectations of our clients. We strive to create value for our customers by providing innovative solutions, exceptional workmanship and a commitment to sustainability. Through our dedication, professionalism and integrity, we aim to contribute to the growth and development of the communities we serve.
            </p>
          </div>
