...
<head>
  ...
  <title>Palazzo general construction - index</title>
...
<body>
  ...
  <section id="hero" class="hero">
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/int.png)"></div>
      <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/const.png)"></div>
      <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/hero-carousel-6.jpg)"></div>
      <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/int2.png)"></div>
        ...
        <div class="row justify-content-between gy-4">
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up">
            <div class="content">
              ...
              <p>Customer Satisfaction: Our clients are at the forefront of everything we do. We believe in open communication, transparency and building strong relationships with our clients. Your satisfaction is our ultimate goal and we work tirelessly to exceed your expectations.
              </p>
            </div>
          </div>
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="assets/img/why choose us.....jpg" alt="" class="img-fluid">
              </div>
            </div>
