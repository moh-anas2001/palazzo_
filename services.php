        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <p>
                The general contractor is the main architect for building projects, so we work in
                coordination and cooperation with both the consultant and the owner to implement
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <p>
                Interior decoration is the design of a dream home or
                place feel comfortable ,so that we aim at Plazzo, we present a comprehensive study of
                the interior design of the projects,
          ...
          <div class="col-lg-5 d-flex flex-column justify-content-center" >
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="100">
              ...
              <div>
                ...
                <p>General construction means the installation, replacement, or repair of a building, structure, highway, sewer, grading, asphalt or concrete paving or improvement of any kind to real property.</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="200">
              ...
              <div>
                ...
                <p> The General Contractor is directly responsible for ensuring a quality build within the quoted timeframe.
                  Manage subcontractors and labor related to the job.</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
              ...
              <div>
                ...
                <p> The General Contractor will be in constant contact with wholesalers and supply stores in order to properly stock the site.</p>
              </div>
            </div><!-- End Icon Box -->

            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
              <i class="fas fa-tasks flex-shrink-0"></i>
              <div>
                <!-- <h4><a href="" class="stretched-link">Tride clov</a></h4> -->
                <p>General Contractor may have the appropriate certifications in some of these areas, and may take on some of the work, it could be necessary to hire others to complete the project.</p>
              </div>
            </div><!-- End Icon Box -->
          </div>
    ...
    <section id="alt-services" class="alt-services">
      <div class="container background-image" data-aos="fade-up">
        ...
        <div class="row justify-content">
          <div class="col-lg-6 img-bg" style="background-image: url(assets/img/inter.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>
...
Madinat Al Riad / Shamkha /Samkha South / Al Wathba /AL Shahama New / Albahya OLD / Madinat Mohammad Bin Zaid / Abu Dhabi Center Corniche Area / Al Slaa. /Airport Road / Alrahba .
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="200">
              ...
              <div>
                <!-- <h4><a href="" class="stretched-link">Nemo Enim</a></h4> -->
                <p> An interior designer is someone who plans, researches, coordinates, and manages such enhancement projects.</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
              ...
              <div>
                <!-- <h4><a href="" class="stretched-link">Dine Pad</a></h4> -->
                <p>Interior design, planning and design of man-made spaces, a part of environmental design and closely related to architecture</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
              ...
              <div>
                <!-- <h4><a href="" class="stretched-link">Tride clov</a></h4> -->
                <p>They also have strong problem-solving and organizational skills and the ability to apply style to create aesthetically pleasing interiors that meet their client's vision.</p>
              </div>
            </div><!-- End Icon Box -->
    ...
    <section id="alt-services-3" class="alt-services section-bg">
      <div class="container background-image" data-aos="fade-up">
        ...
        <div class="row justify-content-between">
          <div class="col-lg-5 d-flex flex-column justify-content-center">
            ...
            <p>MEP  department included all work of mechanical , electrical , plumping and
              ...
              Private Majles MEP Work For Mr. Karl Magnus Villa-9 HaddAlsaadiyat/
              Frame Food Station Restaurant Mechanical Work/ Al Raha Garden Villa 913 ( maintenance
              Work only ) .</p>
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="100">
              ...
              <div>
                <!-- <h4><a href="" class="stretched-link">Lorem Ipsum</a></h4> -->
                <p>The MEP is responsible for ensuring that these systems are installed correctly and meet all applicable codes and standards.</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="200">
              ...
              <div>
                <!-- <h4><a href="" class="stretched-link">Nemo Enim</a></h4> -->
                <p>MEP engineering design validation services provide sustainable solutions for projects across industries such as Hospitals, Commercials Buildings, Industrial and others.</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
              ...
              <div>
                <!-- <h4><a href="" class="stretched-link">Dine Pad</a></h4> -->
                <p>The MEP in construction is responsible for the design, installation, and maintenance of the mechanical, electrical, and plumbing systems in a building</p>
              </div>
            </div><!-- End Icon Box -->
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
              ...
              <div>
                <!-- <h4><a href="" class="stretched-link">Tride clov</a></h4> -->
                <p>MEP engineering is the science and art of planning, designing and managing the MEP systems of a building. An MEP design company specializes in those skills.</p>
              </div>
            </div><!-- End Icon Box -->
          </div>

          <div class="col-lg-6 img-bg" style="background-image: url(assets/img/MEPImages.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>
        </div>
